...
INSERT INTO users(id,username,nickname,password,enabled) VALUES (3,'xin','xin','password',FALSE );
INSERT INTO users(id,username,nickname,password,enabled) VALUES (4,'qian','qian','password',FALSE );

INSERT INTO user_roles(id, username, role) VALUES (1,'chao','ROLE_ADMIN');
INSERT INTO user_roles(id, username, role) VALUES (2,'xin','ROLE_USER');
