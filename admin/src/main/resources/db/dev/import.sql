...
INSERT INTO users(id,username,nickname,password,enabled) VALUES (1,'admin','管理员','admin',TRUE );
INSERT INTO users(id,username,nickname,password,enabled) VALUES (2,'user','chao','user',TRUE );

INSERT INTO authorities(id, username, authority) VALUES (1,'admin','ROLE_ADMIN');
INSERT INTO authorities(id, username, authority) VALUES (2,'user','ROLE_USER');
