...
public class CustomXWPFDocument extends XWPFDocument {
     ...
     * @param ctInline
     */
    public void createPicture(String blipId, int id, int width, int height, CTInline ctInline) {
        final int EMU = 9525;
        width *= EMU;
        height *= EMU;
        //String blipId = getAllPictures().get(id).getPackageRelationship().getId();
        ...
        CTPositiveSize2D extent = ctInline.addNewExtent();
        extent.setCx(width);
        extent.setCy(height);

        CTNonVisualDrawingProps docPr = ctInline.addNewDocPr();
        docPr.setId(id);
