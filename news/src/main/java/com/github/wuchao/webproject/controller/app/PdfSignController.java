...
import com.github.wuchao.webproject.application.impl.PdfServiceImpl;
import com.github.wuchao.webproject.application.impl.PdfServiceImpl;
import com.github.wuchao.webproject.util.ImageUtils;
...
//    @Value("${web.tmp.path}")
    ...
    public String sign(@PathVariable("fileName") String fileName, @RequestParam("imageData") String imageData, @RequestParam("height") float height, @RequestParam("width") float width) {
        ...
        ImageUtils.base64ToImage(imageData, absolutePathWithoutExt + PNG_FILE_EXT);
